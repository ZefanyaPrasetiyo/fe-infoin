...
export default function ExplorePage() {
  ...
  <CarouselPrevious className=" -left-16 top-[45%]" />
  <CarouselNext className="-left-16 top-[55%] translate-y-0" />
</div>
          <div className="absolute bottom-24 right-3 z-20 flex flex-col items-center gap-5 sm:bottom-1/2 sm:right-[-60px] sm:translate-y-1/2">
